...
public class Data {
    String ascii = "@#&$%*o!;.";
    public void get() {
        VideoCapture capture = new VideoCapture("1.mp4");
        if (!capture.isOpened()) {
    ...
    private void setRGB(@NotNull BufferedImage image, int x, int y, int width, int height, int[] pixels) {
